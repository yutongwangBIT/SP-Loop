                             ...
                             const std::vector<cv::Mat> &descriptors, int current_level)
{
    ...
    //std::cout<<"features associated to each cluster"<<std::endl;
        ...
        while(goon)
        {
            ...
            else
            {
                ...
                for(unsigned int c = 0; c < clusters.size(); ++c)
                {
                    ...
                    //std::cout<<"DescManip::meanValue:"<<clusters[c]<<std::endl;
                }
...
//void Vocabulary::save2(string filename)
//{

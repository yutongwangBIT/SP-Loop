...
bool FeatureManager::addFeatureCheckParallax(int frame_count, const map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> &image, double td, map<int,cv::Mat> mdescs)
{
...
/*    for (auto &it_per_id : feature){
    ...
    for (auto &it_per_id : feature)
    {
        ...
        {
            //std::cout<<"start_frame:"<<it_per_id.start_frame<<std::endl;

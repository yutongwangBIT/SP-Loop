...
void new_sequence()
{
    ...
    posegraph_sp.posegraph_visualization->reset();
    posegraph_sp.publish();
    m_buf.lock();
...
void point_callback(const sensor_msgs::PointCloudConstPtr &point_msg)
{
    ...
    */
    ...
    for (unsigned int i = 0; i < point_msg->points.size(); i++)
    {
        ...
        Eigen::Vector3d tmp = posegraph_sp.r_drift * Eigen::Vector3d(p_3d.x, p_3d.y, p_3d.z) + posegraph_sp.t_drift;
...
/*void feature_callback(const vins_estimator::features::ConstPtr &feature_msg)
{
    ...
    // for visualization
    sensor_msgs::PointCloud point_cloud;
    point_cloud.header = feature_msg->header;
...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    vio_t = posegraph_sp.w_r_vio * vio_t + posegraph_sp.w_t_vio;
    vio_q = posegraph_sp.w_r_vio *  vio_q;

    vio_t = posegraph_sp.r_drift * vio_t + posegraph_sp.t_drift;
    vio_q = posegraph_sp.r_drift * vio_q;
